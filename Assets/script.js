$(document).ready(function() { // Wait for the DOM to be ready for window., javascript/jquery and others
    ...
    function createGridSystem() {
      ...
      for ( var hourOfDay = 9; hourOfDay <= 17; hourOfDay++ ) {
        ...
        // TODO: Create a span to hold the text or hour of the day for the hour column cell
        let $columnHourSpan = $('<span></span>')
  
        //TODO: Create a variable to hold the hour of the day to append to column hour span.text
        let $columnHourly = "";
  
        // TODO; Take hourOfDay variable from the loop and assign proper AM/PM values
        switch(hourOfDay) {
